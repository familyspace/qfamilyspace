...
from qfamilyspace.ui.views.left_view import Ui_MainWindow
...
class MainView(QtWidgets.QMainWindow):
    ...
    def _initUI(self):
        ...
        self.left_view = Ui_MainWindow(self.splitter)
        ...
        self.setTabOrder(self.tasks_view.tasks_search_view, self.tasks_view.tasks_list_view)
        self.setTabOrder(self.tasks_view.tasks_list_view, self.left_view)
